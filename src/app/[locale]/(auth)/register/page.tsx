    ...
    >
        ...
        <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: 16 }}>
          {perkKeys.map((key) => (
            <li key={key} style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <span style={{ fontSize: 14, color: "var(--text-2)" }}>{t(key, l)}</span>
            </li>
          ))}
        </ul>
      </div>
      ...
      >
        <div style={{ width: "100%", maxWidth: 400 }}>
          ...
          >
            <Link href="/dashboard" className="btn btn-ghost" style={{ padding: "10px 16px", fontSize: 13, gap: 8, justifyContent: "center" }}>
              <GitHubIcon />
              GitHub
            </Link>
            <Link href="/dashboard" className="btn btn-ghost" style={{ padding: "10px 16px", fontSize: 13, gap: 8, justifyContent: "center" }}>
          ...
          <form style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div>
              ...
              <input name="name" type="text" placeholder="John Doe" style={inp} />
            </div>
            ...
            <div>
              ...
              <input name="email" type="email" placeholder="you@example.com" style={inp} />
            </div>
